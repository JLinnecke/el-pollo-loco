class SmallChicken extends MovableObject {
    ...
    /**
    * Initializes the small chicken, loads images, and starts animations.
    */
    constructor() {
    ...
    /**
    * Manages the small chicken's movement and animations.
    */
    animate() {
    ...
    */
    ...
    /**
    * Plays the death animation and handles the small chicken's death.
    */
    handleDeadAnimation() {
    ...
    playSmallChickenDieAudio() {
        window.playSounds('smallChicken_die_Audio');
    }
}